// Snake Game N2.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "Snake Game N2.h"

#define MAX_LOADSTRING 100

// Global Variables:
HWND gGameWindow;                               // Window Handle
BOOL gGameRunning;                              // Global for Game running instance check
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SNAKEGAMEN2, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SNAKEGAMEN2));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_SNAKEGAMEN2);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   gGameWindow = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
   ...
   ShowWindow(gGameWindow, nCmdShow);
...
void ProcessPlayerInput(void)
{
    ...
    if (escape_key)
    {
        SendMessageW(gGameWindow, WM_DESTROY, 0, 0);
    }
}
